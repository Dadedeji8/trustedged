...
const HomePageNavBar = () => {
    ...
    return (
        <nav className=" shadow-md px-6 py-4 flex  top-0 justify-between items-center w-full fixed bg-white z-20 mb-20">
            <div className="text-2xl font-bold text-lime-600">TrustEdged Bank</div>

            <div className="hidden md:flex space-x-6">
                <Button variant="border border-solid border-lime-600"><Link to={'/authentication/sign-in'}>Sign In</Link></Button>
                <Button className="bg-liblueme-600 hover:bg-blue-900 transition-all duration-300 ease-in-out text-white"><Link to={'/authentication/sign-up'}>Sign up</Link></Button>
            </div>
